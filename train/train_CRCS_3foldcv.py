...
def return_fold_data_path_list():
    train_val_test_dict = joblib.load("../DataSplit/CRCS_3foldcv.pkl")
...
def main(args):
    ...
    handler = logging.FileHandler("../Logs/CRCS_3foldcv.log")
    ...
    for fold_num_temp in range(fold_num):
        ...
        for epoch_num in pbar:
            ...
            if val_info_dict["val_macro_auc"] > best_auc:
                ...
                torch.save(model.state_dict(), "../SavedModels/CRCS_3foldcv/fold{}_best_val_auc_model.pt".format(fold_num_temp + 1))

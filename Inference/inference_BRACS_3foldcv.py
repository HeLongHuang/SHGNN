...
def main(args):
    ...
    BRACS_3foldcv = joblib.load("../DataSplit/BRACS_3foldcv.pkl")
    fold1_test_data_path_list = BRACS_3foldcv["fold1_test"]
    fold2_test_data_path_list = BRACS_3foldcv["fold2_test"]    
    fold3_test_data_path_list = BRACS_3foldcv["fold3_test"] 
...
def get_params():
    ...
    parser.add_argument("--Fold1_Model_path", type=str, default="../SavedModels/BRACS_3foldcv/fold1_best_val_auc_model.pt", help="")
    parser.add_argument("--Fold2_Model_path", type=str, default="../SavedModels/BRACS_3foldcv/fold2_best_val_auc_model.pt", help="")
    parser.add_argument("--Fold3_Model_path", type=str, default="../SavedModels/BRACS_3foldcv/fold3_best_val_auc_model.pt", help="")
